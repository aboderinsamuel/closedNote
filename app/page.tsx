      ...
      <div className="max-w-5xl mx-auto py-4 sm:py-8 px-4">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {user ? (
              <>
                <Link href="/dashboard" className="px-6 py-3 bg-neutral-900 hover:bg-neutral-700 dark:bg-white dark:hover:bg-neutral-200 dark:text-neutral-900 text-white font-medium rounded-full transition-colors text-sm">
                  Open my prompts
                </Link>
